...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Invicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"invicointools.com", "invicointools.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"invicointools.com", "testnet-seed.invicointools.com"},
    {"xurious.com", "testnet-seed.ivc.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Invicoin is probably already running."), addrBind.ToString().c_str());
        else
